...
class modDoliWPshop extends DolibarrModules {
	...
	public function init( $options = '' ) {
		...
		$extra_fields->addExtraField( '_wps_info', 'WPshop Info', 'text', 1001, '', 'product', 2, 0,'','', 0,'','1' );
		...
		$extra_fields->addExtraField( '_wps_multishop', 'WPShop MultiShop', 'text', 100, '', 'product_price', 1, 0, '', '', 0, '', '5' );
		$extra_fields->addExtraField( '_wps_end_date', 'WPShop EndDate', 'date', 100, '', 'product_price', 1, 0, '', '', 0, '', '5' );
